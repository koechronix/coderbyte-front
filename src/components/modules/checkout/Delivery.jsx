      ...
      <div className="border border-slate-300 bg-white p-4 rounded-3px">
        <div className="py-2 rounded-3px p-2 px-1.5 flex flex-col gap-y-2">
          ...
          <div className="pt-4 text-sm text-gray-600">
            ...
            <p className="pt-2 text-sm">Mobile: Your phone your ticket. Locate your tickets in your account - or in your app. When you go mobile, your tickets will not be emailed to you or available for print.</p>
          </div>
        </div>
      </div>
    );
